    ...
    try {
      ...
      try {
        ...
        if (!rpcError && rpcData) {
          ...
          console.log("RPC assignment failed, falling back to frontend assignment...", rpcError?.message);
        ...
        if (assignmentError) {
          ...
          console.log("Student automatically assigned to supervisor:", assignedId);
        } else {
